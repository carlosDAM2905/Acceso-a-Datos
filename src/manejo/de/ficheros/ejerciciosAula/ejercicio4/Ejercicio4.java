package manejo.de.ficheros.ejerciciosAula.ejercicio4;
...
public class Ejercicio4 {
    public static void main(String[] args) throws IOException {
        ...
        String ruta = "src/File/Ejercicios/ejerciciosAula/Ejercicio4/Restaurantes.csv";

        String ruta2 = "src/File/Ejercicios/ejerciciosAula/Ejercicio4/Restaurantes2.csv";
