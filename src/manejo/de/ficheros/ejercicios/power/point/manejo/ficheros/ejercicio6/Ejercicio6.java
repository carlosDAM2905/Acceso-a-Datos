package manejo.de.ficheros.ejercicios.power.point.manejo.ficheros.ejercicio6;
...
public class Ejercicio6 {
    public static void main(String[] args) {
        ...
        String ruta = "src/manejo/de/ficheros/ejercicios/power/point/manejo/ficheros/ejercicio6/Empleados.txt";
        File fichero = new File(ruta);
        ArrayList<String> empleados = new ArrayList<>();
        empleados.add("id: 1 | Nombre: Juan");
        empleados.add("id: 2 | Nombre: Pedro");
        empleados.add("id: 3 | Nombre: Carlos");
        empleados.add("id: 4 | Nombre: Mariano");
        empleados.add("id: 5 | Nombre: Roberto");
